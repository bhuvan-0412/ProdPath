-- ProdPath Supabase Database Initial Schema Migration
-- Save as supabase/migrations/001_init.sql
-- Execute this script in your Supabase Project's SQL Editor once Supabase is active.
...
-- 3. Create Custom Resources Table
...
-- 7. RLS Policies for Custom Resources
...
-- 8. Trigger to automatically create profile on Google / OAuth Sign Up
