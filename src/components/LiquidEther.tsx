...
export default function LiquidEther({
  ...
  useEffect(() => {
    ...
    class MouseClass {
      ...
      cachedRect: { left: number; top: number; width: number; height: number; right: number; bottom: number } | null = null;
    ...
    class Advection extends ShaderPass {
      ...
      update(opts?: { dt: number; isBounce: boolean; BFECC: boolean }) {
        if (!this.uniforms || !this.line || !opts) return;
    ...
    class Viscous extends ShaderPass {
      constructor(simProps: { boundarySpace: THREE.Vector2; cellScale: THREE.Vector2; viscous: number; dt: number; src: THREE.WebGLRenderTarget; dst: THREE.WebGLRenderTarget; dst_: THREE.WebGLRenderTarget }) {
        super({
          material: {
            vertexShader: face_vert,
      ...
      update(opts?: ViscousUpdateProps): THREE.WebGLRenderTarget {
        let fbo_in: THREE.WebGLRenderTarget | undefined;
        let fbo_out: THREE.WebGLRenderTarget | undefined;
        if (!this.uniforms || !opts) return this.props.output1!;
    ...
    class Divergence extends ShaderPass {
      constructor(simProps: { boundarySpace: THREE.Vector2; cellScale: THREE.Vector2; dt: number; src: THREE.WebGLRenderTarget; dst: THREE.WebGLRenderTarget }) {
        super({
          material: {
            vertexShader: face_vert,
      ...
      update(opts?: DivergenceUpdateProps) {
        if (!this.uniforms || !opts) return;
    ...
    class Poisson extends ShaderPass {
      constructor(simProps: { boundarySpace: THREE.Vector2; cellScale: THREE.Vector2; src: THREE.WebGLRenderTarget; dst: THREE.WebGLRenderTarget; dst_: THREE.WebGLRenderTarget }) {
        super({
          material: {
            vertexShader: face_vert,
      ...
      update(opts?: PoissonUpdateProps): THREE.WebGLRenderTarget {
    ...
    class Pressure extends ShaderPass {
      constructor(simProps: { boundarySpace: THREE.Vector2; cellScale: THREE.Vector2; dt: number; src_p: THREE.WebGLRenderTarget; src_v: THREE.WebGLRenderTarget; dst: THREE.WebGLRenderTarget }) {
        super({
          material: {
            vertexShader: face_vert,
      ...
      update(opts?: PressureUpdateProps) {
        if (!this.uniforms || !opts) return;
        this.uniforms.velocity.value = opts.vel.texture;
    ...
    class Simulation {
      ...
      createAllFBO() {
        ...
        this.fbos.vel_0 = new THREE.WebGLRenderTarget(this.fboSize.x, this.fboSize.y, opts);
        this.fbos.vel_1 = new THREE.WebGLRenderTarget(this.fboSize.x, this.fboSize.y, opts);
        this.fbos.vel_viscous0 = new THREE.WebGLRenderTarget(this.fboSize.x, this.fboSize.y, opts);
        this.fbos.vel_viscous1 = new THREE.WebGLRenderTarget(this.fboSize.x, this.fboSize.y, opts);
        this.fbos.div = new THREE.WebGLRenderTarget(this.fboSize.x, this.fboSize.y, opts);
        this.fbos.pressure_0 = new THREE.WebGLRenderTarget(this.fboSize.x, this.fboSize.y, opts);
        this.fbos.pressure_1 = new THREE.WebGLRenderTarget(this.fboSize.x, this.fboSize.y, opts);
      }

      createShaderPass() {
        if (!this.fbos.vel_0 || !this.fbos.vel_1 || !this.fbos.vel_viscous0 || !this.fbos.vel_viscous1 || !this.fbos.div || !this.fbos.pressure_0 || !this.fbos.pressure_1) return;
      ...
      resize() {
        ...
        for (const key in this.fbos) {
          const k = key as keyof SimulationFBOs;
          if (this.fbos[k]) {
    ...
    const applyOptionsFromProps = () => {
      const w = webglRef.current as WebGLManager | null;
    ...
    const ro = new ResizeObserver(() => {
      ...
      resizeRafRef.current = requestAnimationFrame(() => {
        ...
        (webglRef.current as WebGLManager).resize();
      });
    });
